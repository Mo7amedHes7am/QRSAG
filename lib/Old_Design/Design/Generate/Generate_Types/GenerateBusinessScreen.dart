...
// }
//
// late TextEditingController namecontroller, industrycontroller, phonecontroller,
...
//                             suffixIconConstraints: BoxConstraints.expand(width: 40.sp),
//                             focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: clrs.gold,width: 2.sp),borderRadius: BorderRadius.circular(8.sp)),
//                             suffixIcon: !industrycontroller.text.trim().isEmpty?
//                             IconButton(
//                               icon:Icon(
//                                 Icons.close,
//                                 color: Color(0xff6D6D6D),
...
//                               data: "BUSINESS:N:${namecontroller.text.toString()};"
